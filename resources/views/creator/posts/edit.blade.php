...
@section('content')
    ...
    <form method="POST" action="{{ route('creator.posts.update', $post->slug) }}" class="card card-body" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" id="status" name="status">
                    <option value="draft" @selected(old('status', $post->status) === 'draft')>Lưu bản nháp</option>
        ...
        <div class="mt-4 d-flex gap-2">
            ...
            <a class="btn btn-outline-secondary" href="{{ route('creator.posts.index') }}">Hủy</a>
        </div>
    </form>
@endsection
